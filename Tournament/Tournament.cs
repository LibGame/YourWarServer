...
namespace YourWarServer.Tournament
{
    public class Tournament
    {
        ...
        public Tournament(UsersDataBase usersDataBase, int targetParticipantsToStartTournament , TournamentDistributor tournamentDistributor)
        {
        ...
        public void AddParticipant(TournamentParticipant tournamentParticipant)
        {
            ...
            _amountParticipants++;
            _usersDataBase.AddParticeToTournament(tournamentParticipant.Login, $"{_tournamentID}|{tournamentParticipant.BaseSID}|{tournamentParticipant.Login}|{tournamentParticipant.BaseID}|");
